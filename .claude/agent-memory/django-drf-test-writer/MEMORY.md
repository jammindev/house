...
- [Water app / general codebase patterns](codebase-patterns.md) — water factories, viewset naming, agent dispatch pattern, ListableSpec/WritableSpec direct access, comma decimal handling
