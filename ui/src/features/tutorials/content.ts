...
export const TUTORIAL_GUIDES: TutorialGuide[] = [
  ...
  { key: 'shopping', moduleKey: 'shopping', to: '/app/shopping-list', stepIds: ['quickAdd', 'fromStock', 'check', 'agent'] },
  ...
  { key: 'budget', moduleKey: 'budget', to: '/app/budget', stepIds: ['create', 'assign', 'track', 'recurring'] },
