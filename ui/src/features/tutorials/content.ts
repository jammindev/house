...
export const TUTORIAL_GUIDES: TutorialGuide[] = [
  ...
  { key: 'weather', moduleKey: 'weather', to: '/app/weather', stepIds: ['location', 'forecast', 'dashboard'] },
  ...
  { key: 'tasks', moduleKey: 'tasks', to: '/app/tasks', stepIds: ['create', 'organize', 'complete'] },
