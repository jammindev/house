  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'contact-new': resolve(__dirname, 'src/pages/contact-new.tsx'),
        'contact-detail': resolve(__dirname, 'src/pages/contact-detail.tsx'),
        'contact-edit': resolve(__dirname, 'src/pages/contact-edit.tsx'),
        'structure-new': resolve(__dirname, 'src/pages/structure-new.tsx'),
        'structure-detail': resolve(__dirname, 'src/pages/structure-detail.tsx'),
        'structure-edit': resolve(__dirname, 'src/pages/structure-edit.tsx'),
