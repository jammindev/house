...
- [ ] T007 Define server/client boundary per impacted screen (SSR shell, React mount, API flow)
- [ ] T008 Create base models/entities that all stories depend on
- [ ] T009 Configure error handling and logging infrastructure
- [ ] T010 Setup environment configuration management
- [ ] T011 Add baseline frontend bundle budget check for hybrid pages
...
- [ ] T018 [US1] Implement React mount + initial data contract for the impacted page
