// nextjs/src/features/projects/components/TabSheet.tsx
"use client";
...
export default function TabSheet({
    ...
    const trigger = (
        ...
        >
            <span className="font-medium">{t(`projects.tabs.${currentTab}`)}</span>
    ...
    return (
        <SheetDialog
            trigger={trigger}
            title={t("projects.selectTab")}
            description={t("projects.selectTabDescription")}
            ...
            <div className="flex flex-col gap-2">
                {tabs.map((tab) => {
                    ...
                    return (
                        ...
                        >
                            <span className="font-medium">{t(`projects.tabs.${tab}`)}</span>
