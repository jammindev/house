...
export default function InteractionItem({ interaction, documentCount, t }: Props) {
  ...
  const occurredTimeLabel = occurredDate.toLocaleTimeString(undefined, { hour: "2-digit", minute: "2-digit" });
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0 space-y-1">
            ...
            <p className="text-sm text-gray-600 line-clamp-2 whitespace-pre-wrap">{interaction.content}</p>
          </div>
          <div className="flex flex-col items-start gap-1 rounded-lg bg-gray-50 px-3 py-2 text-xs text-gray-600 sm:items-end">
        ...
        {contacts.length > 0 && (
          <div className="space-y-1">
            <p className="text-[11px] font-semibold uppercase tracking-wide text-gray-500">
              {t("interactionscontacts.sectionTitle")}
            </p>
        ...
        {structures.length > 0 && (
          <div className="space-y-1">
            <p className="text-[11px] font-semibold uppercase tracking-wide text-gray-500">
              {t("interactionsstructures.sectionTitle")}
            </p>
            <div className="flex flex-wrap gap-1.5">
