...
export default function ContactEditPage() {
  ...
  const heading = useMemo(
    () => ({
      ...
      subtitle: t("contacts.editSubtitle"),
    }),
    [t]
  );
  ...
  if (contactsError) {
    return (
      <AppPageLayout title={heading.title} subtitle={heading.subtitle}>
        <div className="rounded border border-red-200 bg-red-50 p-4 text-sm text-red-600">{contactsError}</div>
      </AppPageLayout>
    );
  }
  ...
  return (
    <AppPageLayout title={heading.title} subtitle={heading.subtitle} context={context}>
