...
- [apps/documents/views_web.py](../../apps/documents/views_web.py)
- [apps/documents/react/DocumentsPage.tsx](../../apps/documents/react/DocumentsPage.tsx)
- [ui/src/lib/api/documents.ts](../../ui/src/lib/api/documents.ts)
...
- [apps/documents/views_web.py](../../apps/documents/views_web.py)
- [apps/documents/react/DocumentsPage.tsx](../../apps/documents/react/DocumentsPage.tsx)
- [apps/documents/react/DocumentsFilters.tsx](../../apps/documents/react/DocumentsFilters.tsx)
...
- [apps/documents/views_web.py](../../apps/documents/views_web.py)
- [apps/documents/web_urls.py](../../apps/documents/web_urls.py)
- [apps/documents/react/](../../apps/documents/react)
- [ui/src/pages/documents/](../../ui/src/pages/documents)
...
- [apps/documents/serializers.py](../../apps/documents/serializers.py)
- [apps/documents/views.py](../../apps/documents/views.py)
- [ui/src/lib/api/documents.ts](../../ui/src/lib/api/documents.ts)
- [apps/documents/tests/test_api_documents.py](../../apps/documents/tests/test_api_documents.py)
...
- [apps/documents/serializers.py](../../apps/documents/serializers.py)
- [apps/zones/models.py](../../apps/zones/models.py)
- [apps/projects/models.py](../../apps/projects/models.py)
- [apps/documents/react/](../../apps/documents/react)
...
- [apps/documents/react/DocumentsPage.tsx](../../apps/documents/react/DocumentsPage.tsx)
- [apps/documents/react/DocumentListItem.tsx](../../apps/documents/react/DocumentListItem.tsx)
- [ui/src/lib/api/documents.ts](../../ui/src/lib/api/documents.ts)
- [ui/src/locales/en/translation.json](../../ui/src/locales/en/translation.json)
- [ui/src/locales/fr/translation.json](../../ui/src/locales/fr/translation.json)
