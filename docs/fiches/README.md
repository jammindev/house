...
- [CONFIDENTIALITE.md](CONFIDENTIALITE.md) — Confidentialité intra-foyer : une frontière *à l'intérieur* du tenant ; pourquoi une visibilité par lecteur a sept portes et pas une, la distinction masquer/cacher, et pourquoi le garde-fou est structurel (parcours 33)
